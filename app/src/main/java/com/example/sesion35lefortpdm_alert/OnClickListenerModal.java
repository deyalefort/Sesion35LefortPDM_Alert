...
public class OnClickListenerModal implements View.OnClickListener{
    @Override
    public void onClick(View view) {
        ...
        final View formElementsView = inflater.inflate(R.layout.input_modal, null, false);
        //Elementos de ventana alert-modal
        new AlertDialog.Builder(context)
                .setView(formElementsView)
                .setTitle("Ventana Lefort XML prod 1")
